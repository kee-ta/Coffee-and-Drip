...
public class AudioManager : MonoBehaviour
{
    ...
    public void SetVolume(float volumePercent, AudioChannel channel)
    {
        ...
        musicSources[1].volume = 0.8f;
        musicSources[2].volume = musicVolumePercent * masterVolumePercent;
        ambientSources[0].volume = .6f;
        ambientSources[1].volume = .6f;
    ...
    public void PlayMusic(AudioClip clip, float fadeDuration = 1)
    {
        ...
        IEnumerator WaitForABit()
        {
            ...
            Debug.Log("Music Index is: " + activeMusicSourceIndex);
